							...
							<!-- <fieldset>
							  <div class="form-group">
								...
								<div class="input-group">
										...
										<input type="password" id="password" name="password" id="password" class="form-control pwd" data-toggle="password" placeholder="Password">
                                        <div class="input-group-append">
                                            <span class="input-group-text">
											<button class="eyebtn reveal" type="button">
